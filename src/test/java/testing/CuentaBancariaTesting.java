...
class CuentaBancariaTest {
    ...
    void depositarSaldoPositivo() {
        ...
        assertEquals(35, cuentaBancaria.depositar(0), "El saldo debe ser 35 después de depositar");
    }
    ...
    void depositarSaldoCero() {
        ...
        assertEquals(0, cuentaBancaria.depositar(0), "El saldo debe ser 0 después de depositar");
    }
    ...
    void testRetirarCantidadNegativa() {
        ...
        assertEquals("La cantidad a retirar no puede ser negativa", exception.getMessage());
    }
}